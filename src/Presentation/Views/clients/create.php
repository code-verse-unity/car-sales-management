...
<main class="container d-flex flex-column justify-content-center align-items-center py-4 my-4 w-75">
  <h1 class="display-6 fw-bold">Ajouter un nouveau <span class="text-orange">Client</span>.</h1>

  <form action="<?= "/clients" ?>" method="post" class="d-flex flex-column gap-2 py-3 w-75" novalidate>
    <div class="mb-3">
